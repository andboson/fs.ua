...
<head>
    ...
    <?php if ($mode == "downloads") { ?>
        <META HTTP-EQUIV="REFRESH" CONTENT="40"><?php } ?>
...
<body onloadset="<?php echo $focus; ?>" marginwidth=20 marginheight=20 background="img/cutbg.png"
      background-repeat="no-repeat" FOCUSCOLOR="#FF4F38" FOCUSTEXT="#00000" bgcolor="#302226">
        ...
        <table width="400px;" cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td width="277px" background="img/25search.jpg" style="background-repeat:no-repeat;">
                    <p id="stitle">&nbsp;<?php echo $s_value; ?></p></td>
                <td align="left"><input type="image" src="img/21btn.jpg"></td>
            </tr>
        </table>
